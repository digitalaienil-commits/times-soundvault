...
async function respond(
  request: Request,
  context: RouteContext<"/api/library/tracks/[trackId]/downloads/[audioAssetId]">,
) {
  ...
  const object = await getPublishedMediaObject(trackId, audioAssetId, "source");
  return object
    ? mediaObjectResponse(request, object, "attachment")
